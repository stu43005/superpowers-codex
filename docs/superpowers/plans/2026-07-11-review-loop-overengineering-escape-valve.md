...
Expected: `3` (this explicit grouping is deliberately shared by checklist item 6, the round-loop step 4, and Caller control-flow item 5 — all three are intended, consistent usages; do NOT reword the skill to make this 1)
